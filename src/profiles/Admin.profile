...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>scheduleBatchClass</apexClass>
    ...
    <classAccesses>
        <apexClass>testScheduleBatchClass</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>testSendSurvey</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>KM_Product__c.KM_ATM_fee_in_other__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>KM_Product__c.KM_Card_Replacement_Cost__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>KM_Product__c.KM_Cost_per_Calendar_Month__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <loginIpRanges>
    ...
    <objectPermissions>
        ...
        <object>KM_Product__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <tabVisibilities>
        <tab>KM_Product__c</tab>
